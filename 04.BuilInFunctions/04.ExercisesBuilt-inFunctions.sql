...
SELECT peak_name, river_name,CONCAT(LOWER(SUBSTRING(peak_name,1,LENGTH(peak_name)-1)),LOWER(river_name)) 
AS mix FROM peaks, rivers 
WHERE SUBSTRING(peak_name,CHAR_LENGTH(peak_name),CHAR_LENGTH(peak_name)) =LOWER( SUBSTRING(river_name,1,1)) 
ORDER BY mix;

#12
SELECT name, SUBSTRING(start, 1, 10) FROM games
WHERE start BETWEEN 20110101 AND 20120101 
